...
public class Radio implements Device {
	...
	public void printStatus() {
		...
		System.out.println("This is Vietnamese Radio. From Hanoi, the capital city of Socialist Republic of Vietnam");
		
		//Show the current status: enabled or disabled
		(isEnabled) ? System.out.println("Radio is currently enable") : System.out.println("Radio is currently disable");
		
		//Show the current volume
		System.out.println("Radio's volume is " + volume);
		
		//Show the current channel
		System.out.println("Radio's channel is " + channel);
	}
}
